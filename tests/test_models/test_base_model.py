...
class TestSave(unittest.TestCase):
    ...
    def setUp(self):
        ...
        1) If a file  'file.json' exists, rename it, so its content is not
        interefered with by the tests
        2) Create Objects of the BaseModel class
        """
...
class TestDocumentation(unittest.TestCase):
    ...
    def test_self_docuentation(self):
        ...
        self.assertIsNotNone(TestSave.__doc__)
        self.assertIsNotNone(TestBaseModelClass.__doc__)
